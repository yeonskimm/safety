...
const CASES = [
  ...
  // ── [v96] 벌칙 조문(제167~169·174조) 본문 복구 + 법 제1조 격리 해제 ──
  ['안전조치 위반하면 처벌이 어떻게 돼', [`${L} 제168조`]],
  ['사망사고 나면 사업주 처벌', [`${L} 제167조`]],
  ['근로자가 사망하면 벌금 얼마야', [`${L} 제167조`]],
  ['법인도 처벌받나요 양벌규정', [`${L} 제173조`]],
  ['산업안전보건법 목적이 뭐야', [`${L} 제1조`]],
  // ── [v96] KB 전면 재생성(원문 기준): 2026.8.1 시행 신설 조문·표 복구·산안규칙 제2조 격리 해제 ──
  ['안전보건 현황 공시 대상이 어디야', [`${D} 제12조의2`]],
  ['안전보건 현황 공시는 언제까지 해', [`${R} 제8조의2`]],
  ['국소배기장치 제어풍속 기준', [`${K} 제454조`, `${K} 제500조`]],
  ['충전전로 접근한계거리', [`${K} 제321조`]],
  ['전체환기장치 필요환기량 계산', [`${K} 제430조`]],
  ['산안규칙 용어 정의', [`${K} 제2조`]],
];
