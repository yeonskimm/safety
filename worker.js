// ═══════════════════════════════════════════════════════════════════════════
//  오늘의안전 AI 프록시 (Cloudflare Worker) — v96
...
//  법령 근거(RAG): law_kb.json(산안법·시행령·시행규칙·산안규칙 1,230조문)에서 질문 관련 조문을 검색해 프롬프트에 주입
...
//  v96 변경: ⑭ AI 프록시 보호(시스템 프롬프트 서버 고정·IP당 요청 한도·답변 길이 상한) ⑮ 법령 KB v3.0 대응
// ═══════════════════════════════════════════════════════════════════════════
...
// ── 답변 검증: 주입하지 않은 조문번호를 AI가 지어내면 경고로 바꾼다 (v94) ──
